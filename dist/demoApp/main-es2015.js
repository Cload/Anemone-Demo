...
let CustomerDetailComponent = class CustomerDetailComponent {
    ...
    ngOnInit() {
        ...
        let infoFetcher = new src_network_InfoFetcher__WEBPACK_IMPORTED_MODULE_3__["InfoFetcher"]();
        let customerPromise = infoFetcher.FetchCustomerAsync(this.AdHocCustomerNumber);
...
let ListComponent = class ListComponent {
    ...
    ngOnInit() {
        this.customersDataSource = new _angular_material_table__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](this.customers);
        let infoFetcher = new src_network_InfoFetcher__WEBPACK_IMPORTED_MODULE_2__["InfoFetcher"]();
        let customerPromise = infoFetcher.FetchCustomersAsync();
        customerPromise.then((cus) => this.onDataReceived(cus));
        customerPromise.catch(() => alert("Errore nel recupero dei dati"));
    }
};
...
const BASE_API_URL = `https://app.anemone.it/TestApp/api/`;
